...
void create_tabs_ui(void) {
    ...
    /*Adăugăm două taburi*/
    lv_obj_t* tab1 = lv_tabview_add_tab(tabview, "Hello World");
    lv_obj_t* tab2 = lv_tabview_add_tab(tabview, "Hello People");
    lv_obj_t* tab3 = lv_tabview_add_tab(tabview, "Drf. Monitor");
    lv_obj_t* tab4 = lv_tabview_add_tab(tabview, "Demo");
